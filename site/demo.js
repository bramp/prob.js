...
(function () {
  ...
  drawHistogram('normal', Prob.normal(), {
    // μ = 0, σ = 1.0
    nbinsx: 120,
    xrange: [-3, 3],
  });
  drawHistogram('uniform', Prob.uniform(), {
    // min = 0, max = 1.0
    nbinsx: 100,
    xrange: [0, 1],
  });
  drawHistogram('exponential', Prob.exponential(), {
    // λ = 1.0
    nbinsx: 120,
    xrange: [0, 5],
  });
  drawHistogram('lognormal', Prob.lognormal(), {
    // μ = 0, σ = 1.0
    nbinsx: 120,
    xrange: [0, 5],
  });
  drawHistogram('poisson', Prob.poisson(4), {
    // λ = 1.0
    nbinsx: 16,
    xrange: [0, 16],
  });
  drawHistogram('zipf', Prob.zipf(), {
    // s = 1, N = 100
    nbinsx: 101,
    xrange: [0, 101],
  });
